...
class QuestionsResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                TextInput::make('title')->required()->placeholder('Question Title'),
                TextInput::make('description')->required()->placeholder('Description'),
                TextInput::make('slug')->required()->placeholder('slug name'),
            ]);
    }
